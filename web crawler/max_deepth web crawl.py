...
def crawl_web(seed,max_deepth):#max_deepthΪ��ȡ����ҳ������
    tocrawl=[seed]
    crawled=[]
    next_deepth=[]
    deepth=0
    while deepth<max_deepth and tocrawl:
        page=tocrawl.pop()
        if page not in crawled:
            union(next_deepth,get_all_links(get_page(page)))
            crawled.append(page)
        if not tocrawl:#����һ��������һ��
           tocrawl,next_deepth=next_deepth,tocrwal 
           deepth=deepth+1
